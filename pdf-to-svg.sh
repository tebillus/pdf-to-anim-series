...
# Usage: ./pdf-to-svg.sh input.pdf
# This script converts a PDF (single or multi-page) to SVG(s) via intermediate JPG and PBM files,
# processing each page separately and cleaning up intermediates.
# Requires: ImageMagick (for convert) and potrace installed.
...
convert -density 150 "$pdf_file" "${base}-%03d.jpg"
...
echo "Conversion complete. SVG files generated for each page."
