...
# Usage: ./pdf-to-alpha_mov.sh input.pdf holds.csv
...
ffmpeg -framerate 24 -i "png_sequence/frame%05d.png" -vf scale=${width}:-2 -c:v prores_ks -profile:v 4 -pix_fmt yuva444p10le "${base}.mov"
